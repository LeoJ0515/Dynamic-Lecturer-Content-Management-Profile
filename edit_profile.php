...
body::before {
    ...
    background: 
        ...
        repeating-linear-gradient(
            ...
            transparent,
            transparent 20px,
            rgba(100, 180, 220, 0.06) 20px,
            rgba(100, 180, 220, 0.06) 22px
        ),
        repeating-linear-gradient(
            90deg,
            transparent,
            transparent 30px,
            rgba(80, 160, 200, 0.04) 30px,
            rgba(80, 160, 200, 0.04) 31px
        ),
        repeating-linear-gradient(
            135deg,
            transparent,
            transparent 50px,
            rgba(120, 200, 240, 0.05) 50px,
            rgba(120, 200, 240, 0.05) 52px
        );
    pointer-events: none;
    z-index: -1;
...
.btn-back {
    /* 绿色 → 蓝色渐变，透明度 0.85（稍微透明） */
    background: linear-gradient(135deg, rgba(67, 203, 108, 0.85), rgba(33, 150, 243, 0.85));
    color: white !important;
    border: none;
}
.btn-back:hover {
    color: white !important;          /* 保留原有的白色悬停文字特效 */
    /* 如果希望悬停时渐变稍深一点，可加上这行（可选） */
    background: linear-gradient(135deg, #36b55a, #1E88E5);
}
